...
public class cnMessage {
	 ...
	 */
    public cnMessage(String msgtypeid, int headerlength, String encode) {
     ...
     * @param fieldid The field number. 
     * 1 is the secondary bitmap and is not returned as such;
    ...
    public void setValue(int fieldid, Object value, cnType t, int length) {
    	...
    	if (value == null) {
    		...
    		cnValue<Object> v = null;
    		if (t.needsLength()) {
    			v = new cnValue<Object>(t, value, length, encode);
    		} else {
    			v = new cnValue<Object>(t, value, encode);
    		}
    ...
    public void write(OutputStream outs, int lengthBytes, int radixoflengthBytes) throws IOException {
		...
		outs.write(this.header.getAsBinary());
...
//				}
    ...
    protected byte[] writeInternal() { /// 组装输出内容
