...
项目更新：
1.0.0 将原项目改成Maven项目，不需要合并loging包，代码编码改成UTF-8，便于以后修改维护；	2015-01-13 iPan
1.0.1 增加对BINARY、LLBIN、LLLBIN的处理；	2015-02-04 iPan
1.0.2 增加字符串编码的处理，可以在j8583.xml中指定encode或者在cnMessageFactory中指定，默认utf-8;		2015-02-09 iPan
	 修改字符串长度的计算，改成字节数组长度，而不是字符串 长度；			2015-02-10 iPan
	 对cnMessage增加编码的处理；										2015-02-10 iPan
	 对定长字符串ALPHA类型，长度使用字节长度，而不是字符串长度；		2015-02-11 iPan
1.0.3 增加了自定义域字符串拼接与截取操作，在cnValue里面；				2015-03-18 iPan
下载：
原项目地址:https://github.com/teddy-lee/J8583CN.git
新项目地址：https://git.oschina.net/ipan/public/tree/master/J8583CN
